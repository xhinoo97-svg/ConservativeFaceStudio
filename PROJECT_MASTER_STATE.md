...
- CURRENT TECHNICAL HEAD: integration `0be6a34f8f8a2ff5b2f85147aa51ca2e34e787ee`; Track A `77687b3b...`; candidate `b6ce7ebd...`; protocol `268188c5...`; Track B `6d57725a...`.
...
- WHAT WAS JUST COMPLETED: LR-ASPP DEVELOPMENT evidence `0be6a34...`: artifact `9502870418` and 880-case report verified, aggregate frozen gate PASS but Asian/age-50 gaps and checkpoint-license blocker recorded; targeted `19/19`, full `569/569` PASS.
- WHAT IS BEING WORKED ON: read-only DamageMaskNet attempt-3 artifact reconciliation to preserve its failed per-class result and make the no-attempt-4 decision machine-readable.
...
- CURRENT QUALITY RESULT: FBCNN public DEV matrix 6/6 PASS on one identity. Frozen LR-ASPP external validation overall PASS on 40 identities/880 cases (`F1 0.716639`, `IoU 0.579849`), but Asian macro-F1 `0.696471`/min-class `0.243086` and age-50 min-class `0.322288` expose domain gaps. Target95 remains NOT_MEASURED.
...
- NEXT EXACT STEP: retrieve artifact `9307331508` from DamageMaskNet attempt 3, verify its archive/checkpoint/ONNX hashes and failed class metrics, then record `STOPPED_MODEL_DATA_QUALITY_FAIL` without an attempt 4.
...
- Active integration HEAD: `integration/final-paper-quality-local@0be6a34f8f8a2ff5b2f85147aa51ca2e34e787ee`; exact tree `e7929c9e2fa01a9ebfc583603bf4b63a6b5419ee`; exact base `main@2767513f95dde2d417e7c6f1faf2357149a1a32f`.
...
| `integration/final-paper-quality-local` | single final product integration | `0be6a34...` | ACTIVE / LR-ASPP DEV NOT PRODUCTION | targeted 19/19, full 569/569; damage gate BLOCKED, RefFace unauthorized | record DamageMask attempt 3 failure; no attempt 4 |
...
| `research/paper-quality-local-v2` | advanced Track B | `6d57725a...` | ACTIVE / BENCHMARKING | LR-ASPP external run `32676602851` SUCCESS; overall gate PASS; artifact `9502870418` verified; domain NOT_QUALIFIED | resolve licensing and define independent real-photo domain validation |
...
Active `research/paper-quality-local-v2@6d57725aae087bb4a3144d521d91346999f9a4fd`: real CPU BFR/JPEG evidence, 80% governor, Personalized Reference Bank, reference-first repair, hard-gated selector, deterministic fusion, parser adapter, gated RefFace workflow, official-upstream registry/bootstrap, FBCNN DEV matrix and documented LR-ASPP internal/external DEVELOPMENT results.
...
Resolve the LR-ASPP checkpoint licensing route and define a new identity-disjoint real-photo validation with domain-aware acceptance frozen before execution. The observed 40-identity set and stopped small U-Net are not tuning data. RefFace remains NOT_RUN.
...
- DATE/TIME UTC: `2026-08-24`.
- TECHNICAL BRANCH: `research/paper-quality-local-v2`.
- PREVIOUS HEAD: `0d4b5fa2d4fad36c9fde484d2ebdac0ae6a61053`.
- NEW REMOTE HEAD: `edc5da8b55c39815cb34e10da6058ee0d2f4bc90`.
- COMMIT INCLUDED: `Validate frozen LRASPP on 40 new identities`.
- FILES MODIFIED/ADDED: balanced ControlFace external-bank builder, frozen checkpoint/ONNX evaluator, five tests, dedicated push-only workflow and pending status.
- VALIDATION CONTRACT: 40 new identities, 20 female/20 male, five per African/Asian/Caucasian/Indian x sex stratum; two deterministic cases per 11 damage classes = 880; all 16 prior ControlFace identities excluded.
- IMMUTABILITY: exact checkpoint `d510e699...` and ONNX `708c7e9c...`; no optimizer/training path; same frozen F1/IoU/min-class thresholds; final holdout false.
- TESTS: targeted `11/11 PASS`; full local pytest `568/568 PASS`; synthetic entrypoint smoke `440/440`, zero errors, checkpoint/ONNX argmax equal.
- WORKFLOW: `Research LRASPP external validation`, run `32676602851`, in progress at this ledger update. No old U-Net, RefFace or other research workflow triggered.
- NEXT EXACT ACTION: monitor run `32676602851`, verify artifact/hash and classify the unchanged gate without tuning.

### PUSH-20260824-010

- DATE/TIME UTC: `2026-08-24`.
- TECHNICAL BRANCH: `research/paper-quality-local-v2`.
- PREVIOUS HEAD: `edc5da8b55c39815cb34e10da6058ee0d2f4bc90`.
- NEW REMOTE HEAD: `6d57725aae087bb4a3144d521d91346999f9a4fd`.
- COMMIT INCLUDED: `Record LRASPP external validation result`.
- FILES MODIFIED/ADDED: Paper Quality status and `research/LRASPP_EXTERNAL_VALIDATION_RESULT.md`; evidence only, no model/data/threshold/workflow change.
- WORKFLOW: run `32676602851` SUCCESS; all steps PASS; 880/880 cases, zero errors.
- ARTIFACT: `lraspp-external-validation-1`, ID `9502870418`, archive SHA-256 `1357c983343b22f81942b130ae359a0051c0d6b79750417d17d832a89cf6b19c`.
- OVERALL QUALITY: macro-F1 `0.716639`, macro-IoU `0.579849`, minimum class F1 `0.387499`; unchanged overall gate PASS. Binary mask precision `0.673451`, recall `0.928655`, IoU `0.640322`.
- DOMAIN QUALITY: Asian macro-F1 `0.696471`, minimum class F1 `0.243086`; age-50 minimum `0.322288`. Domain robustness NOT_QUALIFIED; no retrospective gate change.
...
- DATE/TIME UTC: `2026-08-24`.
- TECHNICAL BRANCH: `integration/final-paper-quality-local`.
- PREVIOUS HEAD: `eaca320da72f8cd0fa3a629bba9ff25689d5e973`.
- NEW REMOTE HEAD: `e5ea08a756a751c4b6372d140b38fbcffc035506`; exact remote tree `0b98c71b9e6263129557245457ed4cb3ba0f9edc` equals the tested local tree.
- COMMITS / ORIGINS: `f558ac8...` from Track A `ed1c110...`; `21f3a3d...` from `c679924...`; `7fe71d6...` from `fbbde193...`; `e5ea08a...` from candidate commit `b6ce7eb...`.
- FUNCTIONAL EFFECT: truthful block accounting and richer observability artifacts; spatial state maintained across transforms; verified observed donor pixels preserved; exact-canvas repair authority constrained; failed identity checks become structured rollback rather than runtime crashes.
- FILES: 25 application/script/test paths; no workflow, benchmark, release request, consumed marker, model, checkpoint, dataset or threshold path.
- TESTS: affected targeted suite `47/47 PASS`; full pytest `449/449 PASS`; `git diff --check` PASS.
...
- DATE/TIME UTC: `2026-08-24`.
- TECHNICAL BRANCH: `integration/final-paper-quality-local`.
- PREVIOUS HEAD: `b05e5aa595e44e391110b61866b98c1f18c92a28`.
- NEW REMOTE HEAD: `58c89eab2797d5a296dea9ccd0bf9268d9b3fa4e`; exact tree `3fde8858b4c83ac3bcad25965d91236ba9118aaa` equals the tested local tree.
- COMMITS: ten small origin-traced Track B transfers from `895fc94...`, `aaa30a9...`, `badd881...`, `273f8ce...`, `1d03eb7...`, `07ff62c...`, `0075bfd...`, `12608a9...`, `46ed4ae...`, `e8ddcc4...`.
- FILES: `app/personalized_reference_bank.py`, `app/personalized_component_selector.py`, `app/component_bank.py` and their three test modules.
- RESULT: 13 canonical components including face contour; only accepted full references may become global anchors; partial references remain component-local; selector requires both identity-safe ranking and observed component-bank coverage.
- TESTS: targeted `26/26 PASS`; full pytest `480/480 PASS`; diff check PASS.
- SAFETY/QUALITY: model-independent and offline; no checkpoint, model registry, installer, threshold, dataset, workflow or holdout changed. This is a tested foundation, not proof that the production automatic pipeline invokes it.
- CLASSIFICATION: `PERSONALIZED_FOUNDATION_TEST_PASS_NOT_RUNTIME_WIRED`; Target95 NOT_MEASURED; Windows/EliteBook NOT_RUN.
- NEXT EXACT ACTION: integrate damage taxonomy and mask-result contract without a checkpoint, test it, then integrate reference-first routing against that contract. LR-ASPP remains research-only.

### PUSH-20260824-016

- DATE/TIME UTC: `2026-08-24`.
- TECHNICAL BRANCH: `integration/final-paper-quality-local`.
- PREVIOUS HEAD: `58c89eab2797d5a296dea9ccd0bf9268d9b3fa4e`.
- NEW REMOTE HEAD: `51941d847d9b76155943589cd1ff5da46d5d4235`; exact tree `9ecad76a2e394aea289a6c039631cc1a3d10e512`.
- ORIGINS: Track B `a7fa425...`, `5fa13cb...`, `e34d53f...`, `5992b89...`; final test-only integration adaptation `51941d8...` removes dependency on an unintegrated research generator.
- FILES: `app/damage_taxonomy.py`, `app/damage_mask_runtime.py`, `tests/test_damage_mask_runtime.py`.
- CONTRACT: HEALTHY plus 11 damage classes; missing/malformed ONNX fails closed; low-confidence non-healthy logits have zero routing authority; output is diagnostic/mask evidence only and cannot introduce pixels or observed provenance.
- TESTS: targeted `8/8 PASS`; full pytest `488/488 PASS`; diff check PASS.
...
- DATE/TIME UTC: `2026-08-24`.
- TECHNICAL BRANCH: `integration/final-paper-quality-local`.
- PREVIOUS HEAD: `d53316d030bae11572588cc14e6317dcea16c3af`.
- NEW REMOTE HEAD: `7eb08d4c853f40071540c911ef8d5402f0f3f157`; exact tree `4ab5c7ae4a2a959cdd9a14958a37b1f178cdc530`.
- ORIGINS: Track B `74ff1d6...`, `4da6b2c...`, `88a9e19...`, `b812e26...`, `fd09772...`.
- FILES: `app/resource_budget.py`, `tests/test_resource_budget.py`.
- CONTRACT: maximum configured fraction 0.80; CPU affinity/thread caps applied before heavy load; process RSS and total-system used RAM both checked including reservation; one heavy model maximum; over-budget paths raise fail-closed `ResourceBudgetExceeded`.
...
- DATE/TIME UTC: `2026-08-24`.
- TECHNICAL BRANCH: `integration/final-paper-quality-local`.
- PREVIOUS HEAD: `9218dfd85f87b6d9925af681b45fe4f1e8fbd1bc`; tree `a310cd40469ff6c95bc08133134d2b641b56547f`.
- NEW REMOTE HEAD: `5f0045b9f45208cf809684dedecb4f1babdf18e1`; exact tested tree `108cebdc1b5192b7c00f0bb7c1e4537243380a7e`.
- ORIGINS: Track B `4f61b2a...`, `c9b4bb4...`.
- FILES: `app/component_aware_fusion_v2.py`, `tests/test_component_aware_fusion_v2.py`.
- CONTRACT: healthy MAIN remains immutable; original observed reference source indices `1..9` have absolute priority inside their exact provenance map; accepted generated candidates are clipped to explicit repair authority and cannot overwrite MAIN/reference; component-specific candidates precede a whole-face fallback; rejected candidates receive zero authority.
- TESTS: targeted `7/7 PASS`; full pytest `513/513 PASS`; diff check PASS.
...
- DATE/TIME UTC: `2026-08-24`.
- TECHNICAL BRANCH: `integration/final-paper-quality-local`.
- PREVIOUS HEAD: `525e7c959ec085cb24874a8f60a2ad17d26b15c7`; tree `531d884881f3e46403a2e596553a9e6c437649a8`.
- NEW REMOTE HEAD: `36030f4317505fc88f742d9ff3e191dcd64a3181`; exact tested tree `dccc0f2bff14796dc1aabfdfc723f61ff7ddfb9e`.
- FILES: `app/automatic.py`, `app/automatic_integrity_policy.py`, `app/automatic_quality_policy.py`, `app/execution.py`, `tests/test_automatic.py`, `tests/test_automatic_integrity_policy.py`.
- RESULT: with one or more references, automatic ENHANCE is `status=ABSTAIN`, `skipped=true`, `restoration_effective=false`, `restoration_pass=false`, `zero_recovery_is_restoration_pass=false`, and its pixels equal the immediately preceding accepted block. The integrity policy recognizes only this exact named abstention; other skipped mandatory blocks still fail the run. With no references, the existing mild deterministic enhancement remains a real non-zero operation.
...
- DATE/TIME UTC: `2026-08-24`.
- TECHNICAL BRANCH: `integration/final-paper-quality-local`.
- PREVIOUS HEAD: `6bd5488479781a49eaee6edb6d94ae76d83e90c6`; tree `58e635102dc404a2d9fb8045af5c2fb44872ef7e`.
- NEW REMOTE HEAD: `268088a76dff3d12ac744e8c59c04507d6927bcc`; exact tested tree `8efdc619f1bb7614780b0ffedf3937378d15b033`.
- FILES: `app/automatic.py`, `app/worker.py`, `app/main_window.py`, `tests/test_automatic.py`, `tests/test_progress_timeline.py`.
- CANCELLATION CONTRACT: UI request sets a thread-safe event; runner checks it before starting each block; the current block may finish and pass its guardrail, then execution stops before the next block. The worker emits `CANCELLED`, last image/checkpoint and completed-block count; UI preserves the checkpoint/recovery project and does not show cancellation as an error or final-quality result.
- SEMANTIC EVENT CONTRACT: completed events include actual decision/reason, mask pixel counts, provenance source counts/generated code, selected identity metrics and only execution-proven model evidence.
- TESTS: targeted `31/31 PASS`; full pytest `526/526 PASS`; Python compile and diff check PASS.
- LIMIT: cancellation is cooperative, not a mid-kernel kill; current tests are synthetic/Linux and do not replace a Windows UI responsiveness run. No model checkpoint or Target95 evidence was added.
- MODEL/HOLDOUT EFFECT: none. No threshold, dataset, installer, workflow, V3/V4 marker or holdout changed.
- NEXT EXACT ACTION: integrate/test the calibration-required hard-gated Paper Quality candidate selector without wiring or enabling any research backend.

### PUSH-20260824-025

- DATE/TIME UTC: `2026-08-24`.
- TECHNICAL BRANCH: `integration/final-paper-quality-local`.
- PREVIOUS HEAD: `268088a76dff3d12ac744e8c59c04507d6927bcc`; tree `8efdc619f1bb7614780b0ffedf3937378d15b033`.
- NEW REMOTE HEAD: `4cdc439a80887f3852a816417645900ad3af40b2`; exact tested tree `8576fbe94a13251ce6388d2877e1321b12464cfc`.
- ORIGINS: Track B `9dde3ee...`, `d2a9684...`.
- FILES: `app/candidate_selector_v2.py`, `tests/test_candidate_selector_v2.py`.
- CONTRACT: candidate provenance must be generated-only; SFace floor is frozen at `0.363`; wrong-person observed pixels and provenance violations must both be zero; healthy-region MAE cannot exceed `8.0`; geometry drift uses an explicitly calibrated positive limit. Only candidates passing every hard gate receive a weighted score, and weights must exactly cover eight metrics, sum to one and identify a DEVELOPMENT/VALIDATION calibration.
- TESTS: targeted `10/10 PASS`; full pytest `536/536 PASS`; diff check PASS.
...
- DATE/TIME UTC: `2026-08-24`.
- TECHNICAL BRANCH: `integration/final-paper-quality-local`.
- PREVIOUS HEAD: `b8b635670afee6e457702bc6f39a3d2dffc3c43a`; tree `31c691bc0b3d525cdd62635f5b46f2e5c5448553`.
- NEW REMOTE HEAD: `5473bcb2160591cbfbf0df700c6c7731b1ce7598`; exact tested tree `5a74771bd1d4ab2ba4e9a10cc801f1564f342747`.
- FILES: `app/production_readiness.py`, `config/paper-quality-readiness.json`, `scripts/evaluate_production_readiness.py`, `tests/test_production_readiness.py`.
- CONTRACT: exactly 16 named gates cover DEV one-shot protocol, damage/restorer/license/runtime evidence, 300-400 identity-disjoint quality and safety measurement, same-candidate Windows/offline/EliteBook acceptance, exact candidate freeze and independent V5 preparation. Unknown/missing/duplicate gates, altered frozen thresholds/scopes, changed consumed-holdout state, or PASS without evidence are rejected.
- CURRENT DERIVED RESULT: manifest SHA-256 `e4172117e02c9190d1be742eb439fc660393bdd38fcf75d10fce8e081fd57df8`; `paper_quality_ready=false` with 12 blockers; `v5_launch_authorized=false` with 14 blockers. Only the already-proven generic runner and DEV one-shot mock are PASS.
- TESTS: targeted readiness/orchestration/protocol `17/17 PASS`; full pytest `547/547 PASS`; CLI validation, require-ready nonzero behavior, Python compile and diff check PASS.
- MODEL/HOLDOUT EFFECT: none. No backend activation, checkpoint, threshold, dataset, installer, workflow, V3/V4 marker, candidate freeze or V5/holdout object changed.
- NEXT EXACT ACTION: integrate the pinned official-upstream registry/bootstrap and FBCNN adapter as an inactive fail-closed JPEG specialist, prove source revision/checkpoint hash/route/offline rejection locally, then run the complete suite without enabling production routing.

### PUSH-20260824-028

- DATE/TIME UTC: `2026-08-24`.
- TECHNICAL BRANCH: `integration/final-paper-quality-local`.
- PREVIOUS HEAD: `5473bcb2160591cbfbf0df700c6c7731b1ce7598`; tree `5a74771bd1d4ab2ba4e9a10cc801f1564f342747`.
- NEW REMOTE HEAD: `6ea287195a8d9a3f4a39554018beb631d3fd9212`; exact tested tree `98685cb0b91cf03b82e7a846ea2c97c13aed28a1`.
- ORIGINS: Track B `a7ffced`, `b8da228`, `2978be9`, `d4f09f2`, `dfaf7bd`, `0ae6d42`; integration hardening additionally fixes the direct script entrypoint and freezes the verified checkpoint byte size/hash.
- FILES: `app/fbcnn_upstream_backend.py`, `config/upstream-implementations.json`, `scripts/bootstrap_pinned_upstream.py`, `scripts/verify_upstream_implementation_registry.py`, `tests/test_fbcnn_upstream_backend.py`, `tests/test_upstream_implementation_registry.py`.
- VERIFIED IDENTITY: official `jiaxi-jiang/FBCNN@54d1831927506b3247e2d4d245abb4f4dab1a1cd`; code license Apache-2.0; official release v1.0 asset `fbcnn_color.pth`, `287755111` bytes, SHA-256 `8b0e4ef23d59cf7ac934a342cb31a17619e4fa4a0b3374a9d78c5174312387e8`. Separate checkpoint terms remain `NOT_SEPARATELY_VERIFIED`.
- CONTRACT: CFS imports the official architecture from an exact detached research checkout, requires its metadata, rejects any unapproved expected hash and wrong byte size/hash before importing PyTorch/upstream code, runs CPU-only and accepts only JPEG/compression/recompression evidence. Output pixels are generated provenance. No automatic production route or download exists.
- TESTS: targeted registry/bootstrap/backend/lifecycle/readiness `24/24 PASS`; full pytest `560/560 PASS`; registry CLI, exact bootstrap CLI dry-run, Python compile and diff check PASS.
...
- DATE/TIME UTC: `2026-08-24`.
- TECHNICAL BRANCH: `integration/final-paper-quality-local`.
- PREVIOUS HEAD: `08d787930eaca63a3ae6043e83217935e89d6025`; tree `ab39aafda13f4bd4b0bd144b45ea48823cb409a3`.
- NEW REMOTE HEAD: `0be6a34f8f8a2ff5b2f85147aa51ca2e34e787ee`; exact tested tree `e7929c9e2fa01a9ebfc583603bf4b63a6b5419ee`.
- FILES: `config/lraspp-development-evidence.json`, `config/paper-quality-readiness.json`, `tests/test_lraspp_development_evidence.py`.
- ARTIFACT RECONCILIATION: run `32676602851`, Track B `edc5da8...`, artifact `9502870418`, 79,726 bytes/3 files, local/GitHub archive SHA-256 `1357c983343b22f81942b130ae359a0051c0d6b79750417d17d832a89cf6b19c`; report SHA-256 `f20cb922...`, manifest SHA-256 `0b7a5e74...`.
- MEASURED DEVELOPMENT RESULT: ControlFace10K synthetic explicit identities, 40 identities balanced five per race/sex stratum, 880/880 cases and zero errors. Overall macro-F1 `0.7166394225`, macro-IoU `0.5798486773`, minimum class F1 `0.3874992984`, binary precision `0.6734512662`; frozen aggregate gate PASS.
- BLOCKING DOMAIN EVIDENCE: Asian macro-F1 `0.6964714522`, Asian minimum class F1 `0.2430860423`, age-50 minimum class F1 `0.3222879007`; checkpoint redistribution license `NOT_EXPLICIT_UPSTREAM_RESEARCH_ONLY`. Synthetic domain only; Target95 NOT_MEASURED.
- RUNTIME/SAFETY SCOPE: official torchvision LR-ASPP revision `c6f39778...`, checkpoint `d510e699...`, ONNX `708c7e9c...`; exact first-batch argmax parity; CPU `0.00508s/face` in CI; mask logits only, cannot modify image pixels, restoration passes zero, RefFace unauthorized.
- TESTS: targeted evidence/damage/readiness `19/19 PASS`; full pytest `569/569 PASS`; readiness remains false with 12/14 blockers.
- MODEL/HOLDOUT EFFECT: no retraining/tuning, checkpoint addition, damage routing activation, RefFace run, threshold, installer, V3/V4 marker, V5 or final holdout change.
- NEXT EXACT ACTION: retrieve and inspect DamageMaskNet attempt-3 artifact `9307331508`, verify its archive/checkpoint/ONNX hashes and failed per-class metrics, record the stopped hypothesis and do not launch attempt 4.
