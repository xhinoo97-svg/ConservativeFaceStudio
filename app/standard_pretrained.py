...
STANDARD_MODELS: tuple[ModelManifest, ...] = (
    ModelManifest(
        ...
        destination="models/deblur/deblurring_nafnet_2025may.onnx",
        source_url=(
    ...
    ModelManifest(
        ...
        destination="models/parsing/resnet18.onnx",
    ...
    ModelManifest(
        ...
        destination="models/pose/mobilenetv2.onnx",
    ...
    ModelManifest(
        ...
        destination="models/inpainting/inpainting_lama_2025jan.onnx",
        source_url=(
