...
from research.build_damage_source_bank import (
    _identity_from_controlface_path,
    _pick_identities,
)


def test_controlface_path_parser_uses_declared_sex_and_identity_directory() -> None:
    assert _identity_from_controlface_path(
        "ControlFace10K/asian/female/young/identity-123e4567-e89b/face_r1_g2_o3.png"
    ) == ("female", "123e4567-e89b")
    assert _identity_from_controlface_path(
        "ControlFace10K/black/male/adult/identity-xyz/0001.jpg"
    ) == ("male", "xyz")
